...
<html lang="nl">
	...
	<body>
      ...
      <div class="container">
        ...
        <p class="text-white text-center">Ga ondertussen naar de aanmeld form: <a href="/form.html">Klik hier</a></p>
        <p class="text-white text-center">Ga ondertussen naar de admin pagina: <a href="/admin.html">Klik hier</a></p>
        <p class="text-white text-center">Ga ondertussen naar de login pagina: <a href="/login.html">Klik hier</a></p>
