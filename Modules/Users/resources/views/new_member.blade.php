	...
	<body>
      ...
      <div class="container bg-dark mt-4 w-25-sm">
        ...
        <form action="{{ route('members.store') }}" method="POST">
          ...
          <!-- RDW number -->
          <div class="form-group">
            <label for="rdw_number" class="text-white">RDW nummer:</label>
            <input type="text" class="form-control" id="rdw_number" name="rdw_number" aria-describedby="rdw_number" placeholder="Je RDW nummer" required>
          </div>          
