        ...
        <table class="content" width="600" border="0" cellspacing="0" cellpadding="0" style="border-collapse: collapse; border: 1px solid #cccccc;">
          ...
          <tr>
            <td class="body" style="padding: 40px; text-align: left; font-size: 18px; line-height: 1.6;">
              ...
              <br>
              <br>
              Er is een nieuw wachtwoord voor uw email adres aangevraagd.<br>
              Klik op de knop hier beneden om een nieuw wachtwoord in te stellen.<br>
              Ps. Mocht de knop niet werken, kopieer en plak dan de link onderaan in uw browser
              <br>
              <br>
              
              <a href="https://club.trmc.nl/password-reset/{{ $token }}" class="mt-2 mb-2">
                <button type="button" class="btn btn-success">Maak een nieuw wachtwoord</button>
              </a>

              <a href="https://club.trmc.nl/password-reset/{{ $token }}">https://club.trmc.nl/password-reset/{{ $token }}</a>
            </td>
          </tr>
