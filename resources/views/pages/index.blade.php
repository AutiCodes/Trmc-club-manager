...
<html lang="nl">
	...
	<!-- tab icon -->
	<link rel="icon" href="{{ url('/media/images/TRMC_LOGO_PNG.ico') }}" type="image/x-icon">
  </head>
	<body>
		<main>
			<!-- NAVBAR -->
			<nav class="navbar navbar-expand-lg navbar-light bg-dark">
				<a class="navbar-brand" href="#">
					<img src="{{ url('/media/images/TRMC_LOGO_PNG.ico') }}" width="30" height="30" class="d-inline-block align-top" alt="">
					TRMC vlucht manager
				</a>
			...
			<form class="col-lg-6 offset-lg-3 pt-4 pb-4">
				<div class="justify-content-center">
					<!-- TOP TEXT AND IMAGE -->
					<img src="{{ URL::asset('media/images/field.jpg') }}" class="img-fluid rounded pt-3">
				...
				<!-- SEND FORM BUTTON -->
				<button type="button" class="btn btn-success font-weight-bold">Verzenden</button>
			</form>
